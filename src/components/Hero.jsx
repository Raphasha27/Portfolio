...
const Hero = () => (
  <div id="home" className="relative min-h-screen flex flex-col bg-transparent">
    ...
    <div className="w-full px-2 sm:px-6 lg:px-12 relative z-10 mx-auto pt-[calc(var(--nav-h)+0.15rem)] sm:pt-[calc(var(--nav-h)+1.5rem)] flex-1 flex flex-col justify-start pb-1 sm:pb-8">
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-1 sm:gap-8 lg:gap-12 w-full">
        ...
        >
          <div className="relative w-[90px] h-[90px] sm:w-[320px] sm:h-[320px] lg:w-[360px] lg:h-[360px] xl:w-[420px] xl:h-[420px]">
            ...
            <div className="absolute inset-[3px] sm:inset-[4px] rounded-full shadow-[inset_0_0_15px_rgba(0,255,156,0.15)] sm:shadow-[inset_0_0_30px_rgba(0,255,156,0.2)] overflow-hidden bg-black">
              <img
                src={profileImg}
        ...
        <motion.div
          ...
          className="flex flex-col gap-0.5 sm:gap-4 w-full lg:flex-1 min-w-0 lg:pr-6 xl:pr-8 lg:order-1 pt-0 sm:pt-2"
        >
          <div className="w-full">
            ...
            <h1 className="text-base sm:text-4xl lg:text-[40px] xl:text-[56px] font-bold text-white leading-tight w-full mt-0.5 lg:mt-3 break-words">
            ...
            <p className="text-[9px] sm:text-base lg:text-lg text-white/60 leading-snug sm:leading-relaxed w-full line-clamp-2 lg:line-clamp-none">
            ...
            <div className="flex flex-col gap-0.5 sm:gap-4 w-full mt-0.5 sm:mt-2">
              <div className="flex flex-wrap items-center gap-1 sm:gap-3 w-full">
                <a href="#projects" className="px-2 py-1 sm:px-6 sm:py-3 bg-[#00FF9C] text-[#000814] font-semibold rounded-lg hover:bg-[#00e089] hover:shadow-[0_0_20px_rgba(0,255,156,0.4)] transition-all active:scale-[0.97] text-[9px] sm:text-base">
                  View Projects →
                </a>
                <a href="/Koketso_Raphasha_CV.pdf" download className="px-2 py-1 sm:px-6 sm:py-3 border border-white/20 text-white/80 font-medium rounded-lg hover:bg-white/5 hover:border-white/40 hover:text-white transition-all active:scale-[0.97] text-[9px] sm:text-base flex items-center gap-1 sm:gap-2">
                  <Icon name="download" size={10} /> CV
                </a>
                <a href="#contact" className="px-2 py-1 sm:px-6 sm:py-3 border border-blue-500/30 text-blue-400 font-medium rounded-lg hover:bg-blue-600/20 hover:border-blue-400/50 transition-all active:scale-[0.97] text-[9px] sm:text-base">
                  Hire Me
                </a>
            ...
            <div className="overflow-hidden rounded sm:rounded-xl border border-white/5 bg-white/[0.02] backdrop-blur-sm">
              ...
              >
                {[...techArsenal, ...techArsenal].map((tech, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-0.5 sm:gap-2 px-1 sm:px-4 py-0.5 sm:py-1.5 text-[8px] sm:text-sm font-mono border border-white/10 rounded sm:rounded-lg text-white/60 shrink-0 bg-white/[0.03] hover:text-[#00FF9C] hover:border-[#00FF9C]/30 hover:bg-[#00FF9C]/5 transition-colors"
                  >
                    <Icon name={tech.icon} size={8} className="sm:w-3.5 sm:h-3.5" />
                    {tech.name}
                  </span>
                ))}
              </motion.div>
