...
import { ExternalLink, Github, Code2, Shield, Cloud, Brain, Database } from 'lucide-react';
...
const projects = [
  ...
  },
  {
    ...
    description: "Modern SOC dashboard featuring an AI Sentinel for proactive threat analysis and intelligent alerting.",
  ...
  },
  {
    ...
    description: "Climate insight tool with a premium glassmorphic UI providing hyper-local forecasts and climate risk analysis.",
