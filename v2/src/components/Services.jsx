        ...
        {services.map((service, i) => (
          ...
          >
            ...
            <div className="relative flex-1 px-8 pb-10 pt-12 flex flex-col items-center text-center">
              ...
              <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 w-20 h-20 rounded-full bg-[#0a161d] border-2 flex items-center justify-center shadow-lg transition-all duration-500 z-20 border-blue-500/40 text-blue-400 shadow-[0_0_30_rgba(59,130,246,0.2)] group-hover:border-blue-400">
