        ...
        >
          ...
          <div className="flex items-center justify-between sm:justify-start gap-2 pt-0.5">
            <a
              ...
              className="flex items-center gap-1.5 px-2 py-1 sm:px-4 sm:py-2.5 rounded-md sm:rounded-lg border border-[#00FF9C]/25 bg-[#00FF9C]/5 hover:bg-[#00FF9C]/10 transition-all active:scale-95"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-[#00FF9C] shrink-0">
              ...
              <div>
                <div className="text-[6px] sm:text-[9px] font-mono text-[#00FF9C]/60 uppercase tracking-wider">WhatsApp</div>
                <div className="text-[8px] sm:text-xs font-bold text-white leading-none">078 117 2470</div>
              </div>
            </a>
            ...
            <div className="flex items-center gap-1">
              ...
              {socialLinks.map((s, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`w-6 h-6 sm:w-9 sm:h-9 glass rounded-md sm:rounded-lg flex items-center justify-center text-white/50 ${s.color} transition-all border border-white/5 hover:border-current`}
                >
