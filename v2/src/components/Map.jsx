      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="space-y-4">
            <div className="text-green-400 font-bold text-xs tracking-[0.3em] uppercase">— PRESENCE —</div>
            <h2 className="text-4xl font-bold">Global Reach, <span className="text-green-400">Local Roots</span></h2>
          ...
          <div className="glass px-6 py-4 rounded-2xl border border-green-500/20 flex items-center gap-4">
            <div className="w-3 h-3 rounded-full bg-green-500 animate-ping" />
            <span className="text-sm font-bold font-mono text-green-400">Pretoria, South Africa</span>
          </div>
        </div>
        ...
        >
          ...
          <iframe 
            ...
            width="100%" 
            height="100%" 
            style={{ border: 0, filter: 'invert(90%) hue-rotate(150deg) brightness(0.8) contrast(1.2)' }} 
            allowFullScreen="" 
            loading="lazy" 
