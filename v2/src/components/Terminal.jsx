...
const COMMANDS = {
  ...
  whoami: {
    ...
    run: () => [
      ...
      { t: 'sys',  text: '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━' },
      { t: 'dim',  text: '' },
      { t: 'sys',  text: '  🎓 BSc IT Graduate — Richfield Graduate Institute' },
      { t: 'sys',  text: '  🤖 AI Intern — CAPACITI Digital Skills Accelerator' },
  ...
  experience: {
    ...
    run: () => [
      ...
      { t: 'dim',   text: '' },
      { t: 'name',  text: '  AI Intern — CAPACITI Digital Skills Accelerator' },
  ...
  status: {
    ...
    run: () => [
      ...
      { t: 'sys',   text: '  Mode           →  AI Intern @ CAPACITI (active)' },
